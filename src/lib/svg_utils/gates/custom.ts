import type { InitialGateOperation, RowMap, SvgGroup, SvgRect, SvgText, CustomGatePlan } from "$lib";
...
export let CUSTOM: CustomGatePlan = {
  ...
  is_custom: true,
  width: gate_width,
  plan: function (op: InitialGateOperation, gate_name: string, li: number, qr: RowMap): SvgGroup {
    let plan: SvgGroup = {
